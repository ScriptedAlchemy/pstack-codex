...
1. Spawn the installed `comment-sicko` Codex custom agent when selectable. Otherwise spawn a default subagent and tell it to read `agents/comment-sicko.md` from this plugin before reviewing. Pass the scope. Do not restate its rules.
