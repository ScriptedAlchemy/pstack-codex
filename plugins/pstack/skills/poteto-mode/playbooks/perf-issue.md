...
1. Capture a baseline trace via the applicable Codex browser, computer-use, terminal, or project verification skill.
...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to a subagent using your configured perf-issue model (default `gpt-5.6-luna`). Review the diff. Capture a post-fix trace.
