...
Short works when you have asked Codex to keep following poteto-mode throughout the task and the playbook holds the structure. This is a task instruction, not Cursor sticky-mode metadata. Your words carry the intent, and the skill carries the rigor.
