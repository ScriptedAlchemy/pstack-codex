...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading $how, $tdd, and Codex heartbeat automation above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "make it better" gives a Codex heartbeat automation or bounded monitor loop nothing to check. Give a command or artifact that can pass or fail.
